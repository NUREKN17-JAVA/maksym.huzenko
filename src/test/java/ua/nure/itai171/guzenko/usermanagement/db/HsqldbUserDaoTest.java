...
import main.java.ua.nure.itai171.guzenko.usermanagement.db.ConnectionFactory;
...
public class HsqldbUserDaoTest<HsqldbUserDao> extends DatabaseTestCase {
    ...
    private static final String LAST_NAME = "Tom";
    private static final String FIRST_NAME = "Hanx";
